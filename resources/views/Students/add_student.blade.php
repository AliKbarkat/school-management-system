                ...
                <form action="{{route('students.store')}}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-row">
                        ...
                        <div class="col">
                            ...
                            <input type="text" name="name_ar" class="form-control form-control-md" >
                            @error('name_ar')
                        ...
                        <div class="col">
                            ...
                            <input type="text" name="name_en" class="form-control form-control-md" >
                            @error('name_en')
                            <small class="text text-danger">{{ $message }}</small>
                 ...
                 {{-- three row --}}
                      ...
                      <div class="form-row">
                        ...
                        <div class="form-group col">
                            ...
                            <select class="form-control form-control-lg" name="nationalite_id">
                                <option selected>{{trans('students.choose')}}...</option>
                        ...
                        <div class="form-group col">
                            ...
                            <select class="form-control form-control-lg" name="bload_id">
                                <option selected>{{trans('students.choose')}}...</option>
                        ...
                        <div class="form-group col">
                            ...
                            <input type="date" name="date_birth" class="form-control form-control-lg">
                            @error('date_birth')
                            <small class="text text-danger">{{ $message }}</small>
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group col">
                            ...
                            <select class="form-control form-control-lg" name="parant_id">
                                <option selected>{{trans('students.choose')}}...</option>
                    ...
                    <div class="form-group col">
                       ...
                       <input type="file" accept="image/*" class="form-control form-control-sm" name="photos[]" multiple>
                       <br>
                        @error('photos')
                        <small class="text text-danger">{{ $message }}</small>
                        @enderror  
